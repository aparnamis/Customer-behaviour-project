...
SELECT
    CASE
        WHEN customer."Age" BETWEEN 18 AND 25 THEN 'Young Adult'
        WHEN customer."Age" BETWEEN 26 AND 35 THEN 'Adult'
        WHEN customer."Age" BETWEEN 36 AND 50 THEN 'Middle-aged'
        ELSE 'Senior'
    END AS age_group,
    SUM(customer."Purchase Amount (USD)") AS total_revenue
FROM customer
GROUP BY
    CASE
        WHEN customer."Age" BETWEEN 18 AND 25 THEN 'Young Adult'
